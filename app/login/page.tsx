...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white font-sans text-zinc-950 selection:bg-indigo-500/20">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <p className="mb-8 text-sm leading-relaxed text-zinc-500">
              Connect your GitHub account. We will analyze your history and surface the open-source issues built for your skill set.
            </p>

            <button
              onClick={handleGithubLogin}
              disabled={loading}
              className="group flex w-full items-center justify-between gap-3 border border-zinc-900 bg-zinc-950 px-5 py-3.5 text-sm font-medium text-white transition-all hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-60"
            >
              ...
              <ArrowRight className="h-3.5 w-3.5 text-zinc-400 transition-colors group-hover:text-white" />
            </button>
          ...
          <div className="mt-6 text-center">
            <Link href="/" className="text-xs text-zinc-400 transition-colors hover:text-zinc-700">
              Back to ContribIQ
            </Link>
          </div>
        </div>
