...
export default function SkillsNotFoundPage() {
  return (
    <AppShell>
      <section className="flex min-h-screen items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-md rounded-sm border border-zinc-800 bg-zinc-950 p-6">
          <BookOpen className="mb-5 h-8 w-8 text-zinc-500" />
          <p className="text-xs font-bold uppercase tracking-widest text-zinc-500">Page not found</p>
          <h1 className="mt-2 text-2xl font-bold tracking-tight text-zinc-100">Skills is not available yet</h1>
          <p className="mt-3 text-sm font-medium leading-6 text-zinc-500">
            This section is not built as a standalone page. You can review and edit skills during onboarding.
          </p>
          <Link
            href="/dashboard"
